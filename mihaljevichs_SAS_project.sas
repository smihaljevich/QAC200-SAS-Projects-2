...
DATE: Thursday, January 15, 2015     TIME: 2:12:44 PM
PROJECT: mihaljevichs_SAS_project_011415
PROJECT PATH: P:\QAC\qac200\students\smihaljevich\Assignments\mihaljevichs_SAS_project_011415.egp
---------------------------------------- */
...
/* Library assignment for Local.SEAN */
Libname SEAN V9 'P:\QAC\qac200\students\smihaljevich\Assignments' ;
/* Library assignment for Local.EC100006 */
Libname EC100006 V9 'P:\QAC\qac200\students\smihaljevich\Assignments' ;
...
%LET _CLIENTPROJECTPATH='P:\QAC\qac200\students\smihaljevich\Assignments\mihaljevichs_SAS_project_011415.egp';
%LET _CLIENTPROJECTNAME='mihaljevichs_SAS_project_011415.egp';
...
/* -------------------------------------------------------------------
   ...
   Generated on: Thursday, January 15, 2015 at 2:11:49 PM
...
/* -------------------------------------------------------------------
   ...
   Generated on: Thursday, January 15, 2015 at 2:11:50 PM
...
/* -------------------------------------------------------------------
   ...
   Generated on: Thursday, January 15, 2015 at 2:11:51 PM
...
/* -------------------------------------------------------------------
   ...
   Generated on: Thursday, January 15, 2015 at 2:11:52 PM
   By task: List Data1
...
/* -------------------------------------------------------------------
   ...
   Generated on: Thursday, January 15, 2015 at 2:11:53 PM
   ...
   SELECT t1.DUPERSID, 
          ...
          /* CATEGORICAL_MARITAL_STATUS */
            (CASE  
               ...
               THEN 0
             ELSE .
            END) LABEL="Categorized marital status as married (1) or not married (0)" AS CATEGORICAL_MARITAL_STATUS, 
...
/* -------------------------------------------------------------------
   ...
   Generated on: Thursday, January 15, 2015 at 2:11:54 PM
...
PROC SQL;
	CREATE VIEW WORK.SORTTempTableSorted AS
		SELECT T.CATEGORICAL_AGGREGATE_HEALTH, T.CATEGORICAL_EDUCATION, T.MARITAL_STATUS, T.EDRECODE_RECODED, T.AGGREGATE_HEALTH_SCORE, T.CATEGORICAL_PERCEIVED_HEALTH, T.AGGREGATE_PERCEIVED_HEALTH
...
PROC SQL;
	CREATE VIEW WORK.SORT AS
		SELECT T.CATEGORICAL_MARITAL_STATUS, T.CATEGORICAL_EDUCATION
	FROM WORK.QUERY_FOR_AGGREGATE_HEALTH_0000 as T
;
QUIT;
...
PROC FREQ DATA=WORK.SORT
	ORDER=INTERNAL
;
	TABLES CATEGORICAL_MARITAL_STATUS / MISSPRINT  SCORES=TABLE;
...
/* -------------------------------------------------------------------
   ...
   Generated on: Thursday, January 15, 2015 at 2:11:57 PM
...
LIBNAME EC100027 "P:\QAC\qac200\students\smihaljevich\Assignments";
...
PROC SQL;
   ...
   SELECT /* INFULLYR */
      ...
      FROM EC100027.meps_2012_subset_final t1;
QUIT;
...
LIBNAME EC100029 "P:\QAC\qac200\Data\MEPS";
...
/* -------------------------------------------------------------------
   ...
   Generated on: Thursday, January 15, 2015 at 2:11:59 PM
...
/* -------------------------------------------------------------------
   ...
   Generated on: Thursday, January 15, 2015 at 2:12:00 PM
   By task: List Data31
...
/* -------------------------------------------------------------------
   ...
   Generated on: Thursday, January 15, 2015 at 2:12:01 PM
...
/* -------------------------------------------------------------------
   ...
   Generated on: Thursday, January 15, 2015 at 2:12:02 PM
...
/* -------------------------------------------------------------------
   ...
   Generated on: Thursday, January 15, 2015 at 2:12:03 PM
...
/* -------------------------------------------------------------------
   ...
   Generated on: Thursday, January 15, 2015 at 2:12:04 PM
...
/* -------------------------------------------------------------------
   ...
   Generated on: Thursday, January 15, 2015 at 2:12:05 PM
...
/*   START OF NODE: SAS program to manage meps_fullyr_2012   */
%LET _CLIENTTASKLABEL='SAS program to manage meps_fullyr_2012';
%LET _CLIENTPROJECTPATH='P:\QAC\qac200\students\smihaljevich\Assignments\mihaljevichs_SAS_project_011415.egp';
%LET _CLIENTPROJECTNAME='mihaljevichs_SAS_project_011415.egp';
%LET _SASPROGRAMFILE='P:\QAC\qac200\students\smihaljevich\Assignments\SAS program to manage meps_fullyr_2012.sas';

GOPTIONS ACCESSIBLE;
*Program written by Sean Mihaljevich 01/14/15
*The purpose of this SAS program code is to... 
		1) Select a subset of variables deemed relevant in determining if
		ER patients who are at least 18 years old will receive X-rays or MRIs
		2) Recode missing values for certain variables in the subset to "SAS missing"
		3) Reversecode certain variables so that higher values are associated
		with better health
		4)  Sum specific recoded and reverse coded variables to construct a variable
		that measures overall health
		5) Create a categorical variable for overall health from the previous overall
		health variable
		6) Produce various statistics and tables for the variables in question in order
		to check for errors and learn more about these variables and the data set  


*Assign the project library;
LIBNAME SEAN  "P:\QAC\qac200\students\smihaljevich\Assignments" ;

*Create a data subset containing variables relevant in determing
if ER patients who are at least 18 years old will receive X-rays or MRIs;
data sean.meps_fullyr_2012_subset_new;
set sean.meps_fullyr_2012;
...
*Sort the observations by the unique identifier DUPERSID;
      proc sort;
	by DUPERSID;
	run;
* Create a temporary data set that will end up containing recoded variables, reverse coded variables, and
	new aggregate and categorical variables;
	data new;
	set sean.meps_fullyr_2012_subset_new;

*This array recodes missing values to "." for the variables listed, which will help us to construct an aggregate variable later;	
array old1(*) ADGENH42
			ADDAYA42
			ADCLIM42
			ADPALS42
...
array new1(*) ADGENH42_NEW
			...
			EDRECODE_NEW;
do i=1 to dim(old1);
if old1(i)=-1 then new1(i)=.;
else if old1(i)=-8 then new1(i)=.;
else if old1(i)=-9 then new1(i)=.;
else if old1(i)=-7 then new1(i)=.;
else new1(i)=old1(i);
end;

*This array reverse codes the variables listed so that higher values are
associated with better health, which will allow us to construct an aggregate variable later;
array old2(*)ADGENH42_NEW
			ADPAIN42_NEW
			ADCAPE42_NEW
			ADNRGY42_NEW;
array new2(*) ADGENH42_NEW_R
			ADPAIN42_NEW_R
			ADCAPE42_NEW_R
			ADNRGY42_NEW_R;
do i=1 to dim(old2);
...
*Assign descriptive lables to the newly recoded and reverse coded variables;
label ADGENH42_NEW_R="Health in general (recoded missing,reverse coded)";
label ADDAYA42_NEW="Health limits moderate activity (recoded missing)";
label ADCLIM42_NEW="Health limits climbing stairs (recoded missing)";
label ADPALS42_NEW="Accomplished less due to physical problems over 4 week span (recoded missing)";
label ADPWLM42_NEW="Work limit due to physical problems over 4 week span (recoded missing)";
label ADMALS42_NEW="Accomplished less due to mental problems over 4 week span(recoded missing)";
label ADMWLM42_NEW="Work limit due to mental problems over 4 week span (recoded missing)";
label ADPAIN42_NEW_R="Pain limits normal work over 4 week span (recoded missing, reverse coded)";
label ADCAPE42_NEW_R="Felt calm/peaceful over 4 week span(recoded missing, reverse coded)";
label ADNRGY42_NEW_R="Had lots of energy over 4 week span (recoded missing, reverse coded)";
label ADDOWN42_NEW="Felt depressed over 4 week span (recoded missing)";
label ADSOCA42_NEW="Health stopped social activity over 4 week span (recoded missing)";
label EDUCYR_NEW="Years of education when first entered MEPS (recoded missing)";
label EDUYRDEG_NEW="Years of education or highest degree  (recoded missing)";
label MARRY12X_NEW="Marital status (recoded missing)";
label EMPST31_NEW="Employment status RD 3/1 (recoded missing)";
label EMPST42_NEW="Employment status RD 4/2 (recoded missing)";
label EMPST53_NEW="Employment status RD 5/3 (recoded missing)";
label ADINSA42_NEW="Do not need health insurance (recoded missing)";
label ADINSB42_NEW="Health insurance not worth cost (recoded missing)";
label ADRISK42_NEW="More likely to take risks (recoded missing)";
label ADOVER42_NEW="Can overcome ills w/o med help (recoded missing)";
label ADLANG42_NEW="Language of SAQ interview (recoded missing)";
label ADSPRF42_NEW="How easy getting special referral (recoded missing)";
label ADSPEC42_NEW="Need to see specialist (recoded missing)";
label ADDRBP42_NEW="Dr. checked blood pressure (recoded missing)";
label ADSMOK42_NEW="Currently smoke (recoded missing)";
label ADHECR42_NEW="Rating of health care (recoded missing)";
label RTHLTH31_NEW="Perceived health status RD 3/1 (recoded missing)";
label RTHLTH42_NEW="Perceived health status RD 4/2 (recoded missing)";
label RTHLTH53_NEW="Perceived health status RD 5/3 (recoded missing)";
label BMINDX53_NEW="Adult body mass index RD 5/3 (recoded missing)";
label ENGSPK42_NEW="Not confortable speaking english (recoded missing)";
label PLCTYP42_NEW="USC type of place (recoded missing)";
label TYPEPE42_NEW="USC type of provider (recoded missing)";
label PROVTY42_NEW="Provider type (recoded missing)";
label HAVEUS42_NEW="Does person have USC provider (recoded missing)";
label YNOUSC42_NEW="Main reason person does not have USC (recoded missing)";
label EDRECODE_NEW="Education level (recoded missing)";

*Generate an overall health variable AGGREGATE_HEALTH, which is the sum
of the variables specified below;
AGGREGATE_HEALTH = (ADGENH42_NEW_R + ADDAYA42_NEW + ADCLIM42_NEW + ADPALS42_NEW + ADPWLM42_NEW +
					ADMALS42_NEW + ADMWLM42_NEW + ADPAIN42_NEW_R + ADCAPE42_NEW_R + ADNRGY42_NEW_R +
					ADDOWN42_NEW + ADSOCA42_NEW);

*Assign descriptive label to AGGREGATE_HEALTH;
label AGGREGATE_HEALTH = "Aggregate health score (sum of individual measures)";

 *Construct a categorical measure of overall heatlh, by assigning certain ranges
of values of AGGREGATE_HEALTH a single value.  CATEGORICAL_AGGREGATE_HEALTH is
the new variable that is created; 
            if AGGREGATE_HEALTH >=54
          			then CATEGORICAL_AGGREGATE_HEALTH = 5;
            else if AGGREGATE_HEALTH >= 50 and AGGREGATE_HEALTH < 54
               then CATEGORICAL_AGGREGATE_HEALTH = 4;
            else if AGGREGATE_HEALTH >=40 and AGGREGATE_HEALTH < 50
               then CATEGORICAL_AGGREGATE_HEALTH = 3;
            else if AGGREGATE_HEALTH >=26 and AGGREGATE_HEALTH <40
               then CATEGORICAL_AGGREGATE_HEALTH = 2;
           else if AGGREGATE_HEALTH >= 0 and AGGREGATE_HEALTH < 26
              then CATEGORICAL_AGGREGATE_HEALTH = 1;
			else if AGGREGATE_HEALTH = . then CATEGORICAL_AGGREGATE_HEALTH = .;
            label CATEGORICAL_AGGREGATE_HEALTH = "Categorizes AGGREGATE_HEALTH";
run;

*Produce summary statistics for AGGREGATE_HEALTH to better understand the variable;
Title;
Title Summary Statistics for AGGREGATE_HEALTH;
PROC MEANS DATA=new
	FW=12
	PRINTALLTYPES
	CHARTYPE
	...
	VARDEF=DF 	
		...
		MEDIAN 
		Q3	;
	VAR AGGREGATE_HEALTH;
RUN;

*Produce One-Way-Frequency Tables for variables used to create AGGREGATE_HEALTH
to broaden understanding and check for errors;
Title;
Title One-Way-Frequency Tables for Recoded SF-12 Variables;

PROC FREQ DATA=new;

	TABLES ADGENH42_NEW_R / MISSPRINT  SCORES=TABLE;
	TABLES ADDAYA42_NEW / MISSPRINT  SCORES=TABLE;
	TABLES ADCLIM42_NEW / MISSPRINT  SCORES=TABLE;
	TABLES ADPALS42_NEW / MISSPRINT  SCORES=TABLE;
	TABLES ADPWLM42_NEW / MISSPRINT  SCORES=TABLE;
	TABLES ADMALS42_NEW / MISSPRINT  SCORES=TABLE;
	TABLES ADMWLM42_NEW / MISSPRINT  SCORES=TABLE;
	TABLES ADPAIN42_NEW_R / MISSPRINT  SCORES=TABLE;
	TABLES ADCAPE42_NEW_R / MISSPRINT  SCORES=TABLE;
	TABLES ADNRGY42_NEW_R / MISSPRINT  SCORES=TABLE;
	TABLES ADDOWN42_NEW / MISSPRINT  SCORES=TABLE;
	TABLES ADSOCA42_NEW / MISSPRINT  SCORES=TABLE;
RUN;

*Produce Contingency Tables comparing recoded and reverse coded variables used to
create AGGREGATE_HEALTH to the orginal variables from which they were derived.
This step helps broader our understanding of the variables and checks for errors; 
Title;
Title Contingency Tables for Original SF-12 Variables and Recoded SF-12 Variables;
PROC FREQ Data=new;

	TABLES ADGENH42 * ADGENH42_NEW_R /
			NOROW
			NOCOL
			NOPERCENT
			MISSPRINT
	...
	TABLES ADMWLM42 * ADMWLM42_NEW / 
			...
			SCORES=TABLE
			ALPHA=0.05;
	TABLES ADPAIN42 * ADPAIN42_NEW_R /
			NOROW
			NOCOL
			NOPERCENT
			MISSPRINT
			...
			SCORES=TABLE
			ALPHA=0.05;
	TABLES ADCAPE42 * ADCAPE42_NEW_R /
			NOROW
			NOCOL
			NOPERCENT
			MISSPRINT
			...
			SCORES=TABLE
			ALPHA=0.05;
	TABLES ADNRGY42 * ADNRGY42_NEW_R /
			NOROW
			NOCOL
			NOPERCENT
			MISSPRINT
...
*Produce list that includes AGGREGATE_HEALTH and the variables used to 
create AGGREGATE_HEALTH to make sure the summing worked properly;
Title;
Title List AGGREGATE_HEALTH and the Variables Summed to Create AGGREGATE_HEALTH (First 100 Observations);
PROC PRINT DATA=new
	(OBS=100);
	VAR ADGENH42_NEW_R
			ADDAYA42_NEW
